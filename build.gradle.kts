                    ...
                    withType<MavenPublication> {
                        ...
                        pom {
                            ...
                            mailingLists {
                                mailingList {
                                    name.set("Commits")
                                    url.set("https://javacc.org/mailing-list-archive/commits@javacc.java.net/")
                                }
                                mailingList {
                                    name.set("Users")
                                    url.set("https://javacc.org/mailing-list-archive/users@javacc.java.net/")
                                }
                                mailingList {
                                    name.set("Developers")
                                    url.set("https://javacc.org/mailing-list-archive/dev@javacc.java.net/")
                                }
                                mailingList {
                                    name.set("Issues")
                                    url.set("https://javacc.dev.java.net/servlets/SummarizeList?listName=issues")
                                }
                            }
                            developers {
                                developer {
